...
public class JUnitRunner {
    ...
    private DataPackage[] inputRows,expectedOutput;
    private MRDemo mr;
    private ProgramPackage programFile;

    public void setUp(DataPackage[] inputRows, MRDemo mr, ProgramPackage programPackage,DataPackage[] expectedOutput){
    ...
    public void run(){
        ...
        TestCasePackage.setExpectedOutputData(expectedOutput);
